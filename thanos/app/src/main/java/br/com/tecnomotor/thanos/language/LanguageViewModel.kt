...
import br.com.tecnomotor.thanos.language.LanguageResource.AppLanguagesSettings.LANGUAGES_AVAILABLE
...
class LanguageViewModel : ViewModel() {
    ...
    fun setAppLanguage(context: Context, selectedLanguage: String, sharedPres: SharedPreferences) {
        when (selectedLanguage) {
            !in LANGUAGES_AVAILABLE -> changeAppLanguage(context, DEFAULT_PORTUGUESE, sharedPres)
    ...
    private fun setCurrentAppLanguage(
        ...
        when {
            ...
            else -> sharedPres.edit().putString(SHARED_PREFS_ISO_CODE_KEY, DEFAULT_PORTUGUESE)
                .apply()
        }
    }

    private fun getCurrentAppLanguage(langSharedPres: SharedPreferences): String {
        return langSharedPres.getString(SHARED_PREFS_ISO_CODE_KEY, DEFAULT_PORTUGUESE)
            ?: DEFAULT_PORTUGUESE
    }
}